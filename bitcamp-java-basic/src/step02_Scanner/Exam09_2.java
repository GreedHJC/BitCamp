...
public class Exam09_2 {
    public static void main(String[] args) {
        ...
        int[] arr5;
        //배열 변수를 선언한 후 따로 초기화시킬때는 다음과 같이 new 명령을 생략할 수 없다.
...
// 배열 초기화 명령
// 1) 배열 선언 + 초기화
//      데이터타이베[ ] 변수명 = new 데이터타입[](값, 값, 값);
//      - 배열 메모리를 초기화시킬 때는 배열 개수를 지정하지 않는다.
