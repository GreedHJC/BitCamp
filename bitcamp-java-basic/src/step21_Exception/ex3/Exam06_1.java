...
public class Exam06_1 {
    ...
    static void m() {
        ...
        // 프로그램을 즉시 종료하는 경우라면, 스캐너를 다 사용하고 난 다음에 굳이 스캐너에 연결된 키보드와 연결을 끊을 필요는 없다.
        // JVM이 종료되면 OS는 JVM이 사용한 모든 자원을 자동으로 회수하기 때문에 굳이 close()를 호출하지 않은 것이다.
        // 그러나 365일 24시간 내내 실행되는 시스템이라면, 키보드 입력을 사용하지 않는 동안에는 다른 프로그램에서 사용할 수 있도록
        // 스캐너와 연결된 키보드를 풀어줘야 한다. 이것을 "자원해제"라고 부른다.
