package step12_ArrayList_contains_hashCode_equals.ex02_LinkedList;
...
public class LinkedList {
    ...
    protected class Bucket{  
        ...
        public Bucket prev;     // 이 변수에서는 이전 객차 주소를 저장한다.
        
    }

    protected Bucket head;        // 리스트에서 맨 앞 객차의 주소를 저장하는 변수.
    protected Bucket tail;        // 리스트에서 맨 뒤 객차의 주소를 저장하는 변수.
