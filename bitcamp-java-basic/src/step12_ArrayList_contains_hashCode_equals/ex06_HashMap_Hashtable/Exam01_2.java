...
public class Exam01_2 {
    ...
    public static void main(String[] args) {
        ...
        MyKey k6 = new MyKey("컴공", 3);  // k3와 같은 값을 갖는다. 하지만 인스턴스는 다르다!
        System.out.println(map.get(k6));
        // k6로 값을 찾으면 없다고 나온다.
        // 이유?
        //  => HashMap에서 값을 찾을 때 Key가 같아야한다.
        //      Key 객체가 다르더라도 hashCode()의 리턴 값이 하고, equals()의 리턴 값이 true이면 두개의 Key는 같다고 간주한다.
        //  => 그러나 우리가 사용한 MyKey 클래스는 hashCode()와 equals()를 오버라이딩 하지 않았기 때문에, 값이 같더라도 인스턴스가 다르면
        //      hashCode()의 리턴 값이 다르게 나온다.
        //      equals() 또한 false를 리턴한다.
        //  해결책?
        //  => Key로 사용할 클래스는 항상 hashCode()와 equals()를 오버라이딩 하여 같은 값을 갖는 객체에 대해 같은 해시값을 리턴하게 해야 한다.
