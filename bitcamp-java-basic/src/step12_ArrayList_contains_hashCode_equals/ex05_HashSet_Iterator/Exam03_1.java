...
package step12_ArrayList_contains_hashCode_equals.ex05_HashSet_Iterator;
...
public class Exam03_1 {
    ...
    public static void main(String[] args) {
        Member v1 = new Member("홍길동", 20,120);
        Member v2 = new Member("임꺽정", 30,230);
        Member v3 = new Member("유관순", 16,230);
        Member v4 = new Member("안중근", 20,230);
        Member v5 = new Member("유관순", 16,290);
