...
public class Exam01_6 {
    ...
    static class Member{
        ...
        //  => 만약 값을 저장하는 것이 아닌 조회하느 ㄴ용도로만 사용하는 변수라면 대문자로 선언하여 상수임을 표현하라!
    ...
    public static void main(String[] args) {
        ...
        // 회원의 타입을 지정할 때 숫자를 이용하였다. 그런데 소스 코드를 작성한 후 시간이 오래 지나면 숫자의 의미를 기억하기가 쉽지 않다.
        // 소스 코드를 작성한 사람도 숫자의 의미를 기억하기가 쉽지 않은데, 남의 소스 코드를 유지보수하는 사람은 더더욱 숫자의 의미를 파악하기란 어렵다.
        // 주석이나 개발 문서를 자세히 살펴보지 않는 이상에는  숫자의 의미를 파악하기 쉽지 않다.

        // "이런 경우를 방지하고자 나온 문법이 상수이다."
        //  => 즉, 의미있는 이름으로 변수를 만들어 놓고 그 변수에 숫자를 저장한다,.
        //  => 그리고 그 값을 사용할 때는 변수를 통해서 사용한다.
        // 다음은 상수를 사용한 예이다.
