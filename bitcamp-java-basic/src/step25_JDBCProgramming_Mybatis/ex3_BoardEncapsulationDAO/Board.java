...
//  => DTO(Data Transfer Objcet)라 부른다.
//  => "도메인 객체(domain)"라고도 부른다.
package step25_JDBCProgramming_Mybatis.ex3_BoardEncapsulationDAO;
...
public class Board implements Serializable {
    ...
    // DB 테이블의 컬럼 값을 저장할 인스턴스 변술르 준비한다.
    //  => 보통 컬럼이름은 DB관례에 따라서 약자로 기술한다.
