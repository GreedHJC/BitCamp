...
package step25_JDBCProgramming_Mybatis.ex5_MyBatis01;
...
public class Exam01_1 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // => Resources의 getResourceAsStream() 메서드는 파라미터에 지정한 파일 경로를 CLASSPATH에서 찾는다.
        //    그리고 그 파일을 읽을 수 있는 InputStream 도구를 리턴한다.
        // => 개발자가 mybatis-config.xml 파일의 전체 경로를 지정하지 않아도 되기 때문에 매우 편리하다. 
        // => 단 해당 파일은 CLASSPATH에 있어야 한다.
        InputStream inputStream = Resources.getResourceAsStream(
                "step25/ex5/mybatis-config.xml");
        
        // mybatis 설정 파일을 가지고 Builder를 이용하여 SqlSession 공장 객체를 생성한다.
