...
public class Exam06_2 {
    public static void main(String[] args) {
        ...
        System.out.println("---------------------------------------------------");
        System.out.println(7.1217f);
        System.out.println(7 * 0.1);
        //결과 : 0.700000000000000001
        //이유 ?
        // - IEEE-754 규격에 따라 부동소수점을 2진수로 바꾸다보면 정확하게 2진수로 딱 떨어지지 않는 경우가 있다.
        // CPU, OS, 컴파일러, JVM의 문제가 아니다, IEEE-754의 방법에 내재되어 있는 문제이다.
        // 해결책?
...
// 결론!
// - 32 비트(float) 메모리에 부동소수점을 저장할 때는 유효자리수 (거의) 7자리까지 가능하다.
// - 64 비트(double) 메모리에 부동소수점을 저장할 때에는 유효자리수 (거의) 15자리 까지는 가능하다.
// - 그래서 32비트(float)를 단정도(single-precision)라 부르고, 
//     64비트는 두배 정밀하게 값을 저장한다고 해서 배정도(double-precision)이라 부른다.  
...
// - 64비트로 표현하는 방법은 32비트에 대비해 두 배 가량 더 정밀하게 표현할 수 있다고
//     해서 "double-precision(정밀도가 두 배; 배정도)"이라 한다.
// 
// ### 부동소수점을 2진수로 표현하는 방법
