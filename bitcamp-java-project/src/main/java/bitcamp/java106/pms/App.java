...
//         System.out.println("팀 정보 삭제 명령 : team/delete 팀명");
//         System.out.println("회원 등록 명령 : member/add");
//         System.out.println("회원 조회 명령 : member/list");
//         System.out.println("회원 상세조회 명령 : member/view 아이디");
//         System.out.println("회원 정보 변경 명령 : team/update 팀명");
//         System.out.println("회원 정보 삭제 명령 : team/delete 팀명");
...
//             System.out.println("해당 이름의 팀이 없습니다.");
//         } else {  
//             for(int i= teams[i]; i < teamIndex; i++){
//                 tesm[i] = team[i++]
//             }else if( i == deletedPosition -1){
//                 // do nothing...
//             }else if(i>deletedPosition -1){
//                 array2[i-1] = array1[i];
//             }
...
//     public static void main(String [] args){
//         String [] array1 = {"first", "second", "third", "fourth", "fifth" };
//         String [] array2 = null;
//         int deletedPosition = 0;
        
//         Scanner sc = new Scanner(System.in);
//         System.out.print("Which element do you want to delete from an array? ");
//         deletedPosition = sc.nextInt();
