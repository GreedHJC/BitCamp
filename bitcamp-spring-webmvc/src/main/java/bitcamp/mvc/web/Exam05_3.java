// 요청핸들러의 파라미터 - 클라이언트가 보낸 데이터를 객체로 받기
...
public class Exam05_3 {
    ...
    //test:
    //http://localhost:8888/bitcamp-spring-webmvc/mvc/exam05_3/m1?no=1&title=aaa&content=bbb
    @GetMapping(value="m1")  
    @ResponseBody  
    ...
    //객체로 받을 수있는건 담고 낱개로도 받을 수 있다.
    //test:
    //http://localhost:8888/bitcamp-spring-webmvc/mvc/exam05_3/m2?no=1&title=aaa&content=bbb&writer=hong
    @GetMapping(value="m2")  
    @ResponseBody  
    ...
    //test:
    //http://localhost:8888/bitcamp-spring-webmvc/mvc/exam05_3/m3?no=1&title=aaa&content=bbb&user.id=hong
    @GetMapping(value="m3")  
    @ResponseBody  
